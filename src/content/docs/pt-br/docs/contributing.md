...
- [Contribuindo com os serviços](contributing/services/) aborda Server, Web, runtime, API, banco de dados, cache, leitores, testes e mudanças operacionais.
- [Contribuindo com a documentação](contributing/documentation/) aborda Astro/Starlight, escrita, traduções, navegação, links e validação local.
