...
Cada repositório possui dependências, CI, versão e releases independentes. Todos os clientes usam a API e nunca ignoram o Server para acessar banco ou storage.
