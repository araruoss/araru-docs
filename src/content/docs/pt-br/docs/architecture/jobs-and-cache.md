---
title: "Jobs e caches"
description: "Documentação sobre Jobs e caches no ecossistema Araru."
order: 100
...
A fila mantém histórico e claims em `background_jobs`. Cada worker adquire jobs por claim condicionado a status/lease, registra `worker_id`, `lease_until` e `heartbeat_at`, ordena prioridade/data, deduplica por chave e persiste tentativas. O agendamento e alguns caches continuam locais ao processo.
