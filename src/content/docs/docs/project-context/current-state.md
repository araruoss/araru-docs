...
Android and Desktop clients, audiobooks, and a plugin ecosystem remain planned. Cloudflare R2, API v1, pagination, storage capabilities, and worker leases are implemented in the merged Server `main`; MOBI support has format limitations. Planned items must not be presented as released.
