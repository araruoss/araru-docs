...
Clientes Android e Desktop, Cloudflare R2, audiolivros e um ecossistema de plugins continuam planejados. MOBI possui limitações do formato. Paginação e versionamento da API ainda não são contratos universais. Itens planejados não podem ser apresentados como lançados.
